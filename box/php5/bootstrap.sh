...
DEBIAN_FRONTEND=noninteractive apt-get install -y antiword apache2 build-essential bzip2 curl git libav-tools locales locate mailutils ntpdate openjdk-7-jre php5 php-apc php5-cli php5-curl php5-dev php5-gd php5-imagick php5-ldap php5-mcrypt php-pear php5-pgsql php5-sqlite php5-svn postfix postgresql-9.4 subversion xpdf-utils vim
